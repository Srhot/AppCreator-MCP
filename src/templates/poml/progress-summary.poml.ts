...
export const PROGRESS_SUMMARY_POML = `<poml>
  ...
  <output format="progress-dashboard">
    ...
    **Days Elapsed:** {{daysElapsed}}
    ...
    ---
    *Progress report generated by AppCreator*
  </output>
...
export function generateMotivationalMessage(
  ...
  const messages: Record<string, string[]> = {
    early: [
      "🚀 Great start! You're building solid momentum!",
      "🌟 Excellent beginning! Keep this energy going!",
      "💪 Strong start! The foundation is being laid perfectly!",
    ],
    quarter: [
      "🎯 25% complete! You're making real progress!",
      "⭐ Quarter of the way there! Fantastic work!",
      "🔥 Heating up! 25% done and going strong!",
    ],
    half: [
      "🎉 Halfway there! Outstanding progress!",
      "🏆 50% complete! You're crushing it!",
      "💎 Midway milestone achieved! Incredible work!",
    ],
    threeQuarter: [
      "🚀 75% complete! The finish line is in sight!",
      "⭐ Three quarters done! Almost there!",
      "🔥 Nearly complete! Keep pushing forward!",
    ],
    final: [
      "🎊 90%+ complete! Sprint to the finish!",
      "🏁 Final stretch! You've got this!",
      "💪 Almost done! Give it your all!",
    ],
    completed: [
      "🎉🎉🎉 PROJECT COMPLETE! Congratulations! 🎉🎉🎉",
      "🏆 FINISHED! Outstanding achievement!",
      "⭐ SUCCESS! You did it! Celebrate this victory!",
    ],
  };
  ...
  if (averageTasksPerDay >= 5) {
    return `${randomMessage}\n\n    ⚡ Velocity: ${averageTasksPerDay.toFixed(1)} tasks/day - You're on fire!`;
  } else if (averageTasksPerDay >= 3) {
    return `${randomMessage}\n\n    📈 Velocity: ${averageTasksPerDay.toFixed(1)} tasks/day - Great pace!`;
  }
