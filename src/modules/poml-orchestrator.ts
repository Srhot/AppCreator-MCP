...
Return ONLY the continuation prompt text.`;
  ...
  exportPOML(state: POMLState): string {
    ...
    poml += `# Generated by AppCreator AI Software Factory\n`;
    ...
    poml += `state_file = ".appcreator/state.json"\n`;
    poml += `spec_kit_file = ".appcreator/spec-kit.json"\n`;
    poml += `checkpoints_file = ".appcreator/checkpoints.json"\n`;
    poml += `continuation_prompt_file = ".appcreator/continuation-prompt.txt"\n\n`;
...
2. Update POML file
3. Save state to .appcreator/state.json
